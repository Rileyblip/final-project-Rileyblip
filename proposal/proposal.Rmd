...
glimpse(bmi)
```
I try to knit without `eval=FALSE` but I can't because there is an error that says "! object `bmi` not found" and it cand read the excel file either, and I don't know how to switch it from excel to csv like the original is.
